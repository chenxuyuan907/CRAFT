...
## Dependency
CRAFT is built based on the R packages "BayesPrism", "mr.mash.alpha", and "ACAT", we sincerely appreciate the authors of these packages.
